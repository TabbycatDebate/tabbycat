...
class TestPowerPairedDrawGeneratorParts(unittest.TestCase):
    ...
    def test_swap_institution(self):
        ...
        expected = [((1, 6), ["1u1d_inst"]), ((2, 5), ["1u1d_other"]), ((3, 7), []), ((4, 8), [])]
        self.one_up_one_down(data, expected)
    ...
    def test_swap_history(self):
        ...
        expected = [((1, 6), ["1u1d_hist"]), ((2, 5), ["1u1d_other"]), ((3, 7), []), ((4, 8), [])]
        self.one_up_one_down(data, expected)
    ...
    def test_last_swap(self):
        ...
        expected = [((1, 5), []), ((2, 6), []), ((3, 8), ["1u1d_other"]), ((4, 7), ["1u1d_hist"])]
        self.one_up_one_down(data, expected)
...
class TestPowerPairedDrawGenerator(unittest.TestCase):
    ...
    standings = dict()
    standings[1] = [
        ((12, "B", 4, [26, 11, 15, 14]), {"side_history": [2, 2], "allocated_side": "aff"}),
...
class TestPowerPairedWithAllocatedSidesDrawGeneratorPartOddBrackets(unittest.TestCase):
    ...
    brackets[4] = OrderedDict(
        [
            ...
            (
                2,
                {
                    "aff": ["John Hopkins 1", "Stanford 1", "MIT 1", "Stanford 3", "Berkeley 1"],
                    "neg": ["MIT 2", "Columbia 1", "Caltech 1", "Caltech 3"],
                },
            ),  # noqa: E501
            (
                1,
                {
                    "aff": ["Caltech 2", "Cornell 1", "Yale 3", "Princeton 1"],
                    "neg": ["Chicago 2", "Chicago 1", "Pennsylvania 1", "Chicago 3", "Princeton 2"],
                },
            ),  # noqa: E501
    ...
    expecteds["pullup_top"][4] = OrderedDict(
        [
            (
                3,
                {
                    "aff": ["Yale 2", "Stanford 2", "Yale 1"],
                    "neg": ["MIT 2", "Columbia 1", "Caltech 1"],
                },
            ),
            (
                2,
                {
                    "aff": ["John Hopkins 1", "Stanford 1", "MIT 1", "Stanford 3", "Berkeley 1"],
                    "neg": ["Caltech 3", "Chicago 2", "Chicago 1", "Pennsylvania 1", "Chicago 3"],
                },
            ),  # noqa: E501
            (
                1,
                {
                    "aff": ["Caltech 2", "Cornell 1", "Yale 3", "Princeton 1"],
                    "neg": ["Princeton 2", "Pennsylvania 2", "Harvard 1", "Harvard 2"],
                },
            ),  # noqa: E501
            (0, {"aff": [], "neg": []}),
        ]
    ...
    expecteds["pullup_bottom"][4] = OrderedDict(
        [
            (
                ...
                {
                    "aff": ["Yale 2", "Stanford 2", "Yale 1"],
                    "neg": ["Columbia 1", "Caltech 1", "Caltech 3"],
                },
            ),
            (
                2,
                {
                    "aff": ["John Hopkins 1", "Stanford 1", "MIT 1", "Stanford 3", "Berkeley 1"],
                    "neg": ["MIT 2", "Chicago 1", "Pennsylvania 1", "Chicago 3", "Princeton 2"],
                },
            ),  # noqa: E501
            (
                1,
                {
                    "aff": ["Caltech 2", "Cornell 1", "Yale 3", "Princeton 1"],
                    "neg": ["Chicago 2", "Pennsylvania 2", "Harvard 1", "Harvard 2"],
                },
            ),  # noqa: E501
            (0, {"aff": [], "neg": []}),
        ]
    ...
    expecteds["intermediate1"][4] = OrderedDict(
        [
            ...
            (
                1.5,
                {
                    "aff": ["Stanford 1", "MIT 1", "Stanford 3", "Berkeley 1"],
                    "neg": ["Chicago 2", "Chicago 1", "Pennsylvania 1", "Chicago 3"],
                },
            ),
            ...
            (
                0.5,
                {
                    "aff": ["Cornell 1", "Yale 3", "Princeton 1"],
                    "neg": ["Pennsylvania 2", "Harvard 1", "Harvard 2"],
                },
            ),
            (0, {"aff": [], "neg": []}),
        ]
    ...
    expecteds["intermediate2"][3] = OrderedDict(
        [
            (5, {"aff": [], "neg": []}),
            (4 + 2.0 / 3, {"aff": [1], "neg": [13]}),
            (4 + 1.0 / 3, {"aff": [2], "neg": [14]}),
            (4, {"aff": [], "neg": []}),
            (3.5, {"aff": [3, 4], "neg": [15, 16]}),
            (3, {"aff": [], "neg": []}),
            (2 + 2.0 / 3, {"aff": [5, 6, 7], "neg": [17, 18, 19]}),
            (2 + 1.0 / 3, {"aff": [8, 9], "neg": [20, 21]}),
            (2, {"aff": [], "neg": []}),
            (1, {"aff": [10, 11], "neg": [22, 23]}),
            (0.5, {"aff": [12], "neg": [24]}),
            (0, {"aff": [], "neg": []}),
