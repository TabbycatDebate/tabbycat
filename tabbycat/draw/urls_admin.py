...
urlpatterns = [
    path(
        ...
        include(
            [
                # Creation/Release
                path("", views.AdminDrawView.as_view(), name="draw"),
                path("create/", views.CreateDrawView.as_view(), name="draw-create"),
                path("details/", views.AdminDrawWithDetailsView.as_view(), name="draw-details"),
                path(
                    "position-balance/",
                    views.PositionBalanceReportView.as_view(),
                    name="draw-position-balance",
                ),
                path("confirm/", views.ConfirmDrawCreationView.as_view(), name="draw-confirm"),
                path(
                    "regenerate/confirm/",
                    views.ConfirmDrawRegenerationView.as_view(),
                    name="draw-confirm-regenerate",
                ),
                path("regenerate/", views.DrawRegenerateView.as_view(), name="draw-regenerate"),
                # Email
                path(
                    "email-adjudicators",
                ...
                path("edit/", views.EditDebateTeamsView.as_view(), name="edit-debate-teams"),
                # Display
                path("display/", views.AdminDrawDisplayView.as_view(), name="draw-display"),
                path(
                    "display-by-venue/",
                ...
                path("release/", views.DrawReleaseView.as_view(), name="draw-release"),
                path("unrelease/", views.DrawUnreleaseView.as_view(), name="draw-unrelease"),
                # Scheduling
                path(
                    "start-time/set/",
