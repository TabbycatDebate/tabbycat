<template>
  <section :class="['db-margins-m db-bordered db-flex-row',
    ...
    <div class="db-padding-horizontal db-flex-item-1 db-flex-row">
      ...
      <div v-if="question.type === 'comment'" class="db-align-vertical-center db-flex-item db-vertical-center-text" v-html="question.text"></div>

      <div v-if="question.type !== 'comment' && question.type !== 'tl'" class="db-align-vertical-center db-flex-item db-flex-static db-vertical-center-text">
        {{ question.text }}
      </div>
      ...
      <div v-if="question.type === 't'" class="db-flex-item-1 db-flex-row db-flex-item db-fill-in"></div>
