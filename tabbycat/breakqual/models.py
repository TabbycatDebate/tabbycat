...
class BreakCategory(models.Model):
    ...
    name = models.CharField(
        max_length=50, verbose_name=_("name"), help_text=_('Name to be displayed, e.g., "ESL"')
    )
    slug = models.SlugField(verbose_name=_("slug"), help_text=_('Slug for URLs, e.g., "esl"'))
    ...
    is_general = models.BooleanField(
        verbose_name=_("is general"), help_text=_("Are teams eligible for this break by default")
    )
    priority = models.IntegerField(
        verbose_name=_("priority"),
        help_text=_(
            "If a team breaks in multiple categories, higher priority "
    ...
    rule = models.CharField(
        max_length=25,
        choices=BREAK_QUALIFICATION_CHOICES,
        default="standard",
        verbose_name=_("rule"),
        help_text=_(
    ...
    breaking_teams = models.ManyToManyField(
        "participants.Team", through="BreakingTeam", verbose_name=_("breaking teams")
    )
...
class BreakingTeam(models.Model):
    break_category = models.ForeignKey(
        BreakCategory, models.CASCADE, verbose_name=_("break category")
    )
    team = models.ForeignKey("participants.Team", models.CASCADE, verbose_name=_("team"))
    rank = models.IntegerField(verbose_name=_("rank"))
    break_rank = models.IntegerField(blank=True, null=True, verbose_name=_("break rank"))
