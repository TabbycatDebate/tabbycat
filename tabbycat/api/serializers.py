...
from .fields import (AdjudicatorFeedbackIdentityField, AnonymisingHyperlinkedTournamentRelatedField, DebateHyperlinkedIdentityField,
    MotionHyperlinkedIdentityField, MotionHyperlinkedRelatedField, RoundHyperlinkedIdentityField, RoundHyperlinkedRelatedField,
...
class RoundPairingSerializer(serializers.ModelSerializer):
    ...
    url = RoundHyperlinkedIdentityField(view_name='api-pairing-detail', lookup_url_kwarg='debate_pk')
...
class BallotSerializer(TabroomSubmissionFieldsMixin, serializers.ModelSerializer):
    ...
    class ResultSerializer(serializers.Serializer):
        class SheetSerializer(serializers.Serializer):
            ...
            class TeamResultSerializer(serializers.Serializer):
                ...
                team = TournamentHyperlinkedRelatedField(
                    view_name='api-team-detail',
                    queryset=Team.objects.all(),
                )
                ...
                class SpeechSerializer(serializers.Serializer):
                    ...
                    speaker = TournamentHyperlinkedRelatedField(
                        view_name='api-speaker-detail',
            ...
            adjudicator = TournamentHyperlinkedRelatedField(
                view_name='api-adjudicator-detail',
                queryset=Adjudicator.objects.all(),
    ...
    motion = MotionHyperlinkedRelatedField(view_name='api-motion-detail', required=False, tournament_field='round__tournament',
        queryset=Motion.objects.all())
    url = DebateHyperlinkedIdentityField(view_name='api-ballot-detail')
