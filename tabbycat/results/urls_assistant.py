...
urlpatterns = [
    # Viewing
    path("", views.AssistantResultsEntryView.as_view(), name="results-assistant-round-list"),
    # Ballots
    path(
        "ballots/<int:pk>/edit/",
