...
class BallotSubmissionAdmin(TabbycatModelAdminFieldsMixin, ModelAdmin):
    ...
    search_fields = (
        "debate__debateteam__team__short_name",
        "debate__debateteam__team__institution__name",
    )
    ...
    def get_queryset(self, request):
        return (
            super(BallotSubmissionAdmin, self)
            .get_queryset(request)
            .select_related("submitter", "confirmer", "debate__round__tournament")
            .prefetch_related(
                Prefetch(
    ...
    def resave_ballots(self, request, queryset):
        q = queryset.select_related("debate__round__tournament").order_by(
            "debate__round__tournament_id"
        )
        count = q.count()
...
class TeamScoreAdmin(TabbycatModelAdminFieldsMixin, ModelAdmin):
    ...
    search_fields = (
        ...
        "debate_team__debate__round__tournament__name",
        "debate_team__team__short_name",
        "debate_team__team__institution__name",
    )
    ...
    def get_queryset(self, request):
        return (
            ...
            .prefetch_related(
                Prefetch(
                    "ballot_submission__debate__debateteam_set",
...
class TeamScoreByAdjAdmin(TabbycatModelAdminFieldsMixin, ModelAdmin):
    ...
    def get_queryset(self, request):
        return (
            super(TeamScoreByAdjAdmin, self)
            .get_queryset(request)
            .select_related(
                "ballot_submission__debate__round__tournament",
...
class SpeakerScoreByAdjAdmin(TabbycatModelAdminFieldsMixin, ModelAdmin):
    ...
    def get_queryset(self, request):
        ...
        return (
            super(SpeakerScoreByAdjAdmin, self)
            .get_queryset(request)
            .select_related(
                "ballot_submission__debate__round__tournament",
                "debate_adjudicator__adjudicator",
