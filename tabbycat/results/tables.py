...
class ResultsTableBuilder(TabbycatTableBuilder):
    ...
    def get_ballot_cells(self, debate, tournament, view_role, user):
        ...
        return {
            ...
            "new_ballot": reverse_tournament(
                new_link, self.tournament, kwargs={"debate_id": debate.id}
            ),
            "merge_ballot": reverse_tournament(
                merge_link, self.tournament, kwargs={"debate_id": debate.id}
            ),
        }
