    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=utils.models.UniqueConstraint(
                fields=("debate", "version"), name="results_ballotsubmission_debate__version_uniq"
            ),
        ),
        migrations.AddConstraint(
            model_name="speakerscore",
            constraint=utils.models.UniqueConstraint(
                fields=("debate_team", "position", "ballot_submission"),
                name="results_speakerscore_debate_team__position__ballot_submission_uniq",
            ),
        ),
        migrations.AddConstraint(
            model_name="speakerscorebyadj",
            constraint=utils.models.UniqueConstraint(
                ...
                name="results_speakerscorebyadj_debate_adjudicator__debate_team__position__ballot_submission_uniq",
            ),
        ),
        migrations.AddConstraint(
            model_name="teamscore",
            constraint=utils.models.UniqueConstraint(
                fields=("debate_team", "ballot_submission"),
                name="results_teamscore_debate_team__ballot_submission_uniq",
            ),
        ),
        migrations.AddConstraint(
            model_name="teamscorebyadj",
            constraint=utils.models.UniqueConstraint(
                fields=("debate_adjudicator", "debate_team", "ballot_submission"),
                name="results_teamscorebyadj_debate_adjudicator__debate_team__ballot_submission_uniq",
            ),
        ),
    ]
