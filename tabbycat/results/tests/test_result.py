...
from results.result import (
    ...
    ResultError,
)  # absolute import to keep logger's name consistent
...
class BaseTestDebateResult(TestCase):
    ...
    def setUp(self):
        ...
        for i in range(2):
            inst = Institution.objects.create(
                code="Inst{:d}".format(i), name="Institution {:d}".format(i)
            )
            team = Team.objects.create(
                tournament=self.tournament,
                institution=inst,
                reference="Team {:d}".format(i),
    ...
    def save_blank_result(self, nadjs=3, nspeakers=3):
        ...
        ballotsub = BallotSubmission.objects.create(
            debate=self.debate, confirmed=True, submitter_type=BallotSubmission.Submitter.TABROOM
        )
...
class TestVotingDebateResultWithScores(GeneralSpeakerTestsMixin, BaseTestDebateResult):
    ...
    testdata["high"] = {  # standard high-point win
        "input": {
            ...
            "scores": [
                [[75.0, 76.0, 74.0, 38.0], [76.0, 73.0, 75.0, 37.5]],
        ...
        "common": {
            ...
            "everyone_scores": [
                [74.66666666666667, 75.33333333333333, 75.0, 37.5],
    ...
    testdata["low"] = {  # contains low-point wins that reverse the result
        "input": {
            ...
            "scores": [
                [[73.0, 76.0, 79.0, 37.5], [77.0, 77.0, 78.0, 39.0]],
        ...
        "common": {
            ...
            "everyone_scores": [
                [75.0, 75.33333333333333, 75.33333333333333, 36.166666666666664],
    ...
    testdata["tie"] = {  # contains three tied-point wins
        "input": {
            ...
            "scores": [
                [[73.0, 72.0, 78.0, 40.0], [73.0, 75.0, 75.0, 40.0]],
        ...
        "common": {
            ...
            "everyone_scores": [
                [75.66666666666667, 74.33333333333333, 77.33333333333333, 39.166666666666664],
    ...
    def test_initially_unknown_sides(self):
        self._unset_sides()
        testdata = self.testdata["high"]
        self.save_complete_result(
            testdata, post_create=lambda result: result.set_sides(*self.teams)
        )
        result = self.get_result()
