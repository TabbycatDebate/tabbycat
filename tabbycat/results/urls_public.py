...
urlpatterns = [
    # Viewing
    path("", views.PublicResultsIndexView.as_view(), name="results-public-index"),
    path(
        "debate/<int:pk>/scoresheets/",
    ...
    path(
        ...
        include(
            [
                path("", views.PublicResultsForRoundView.as_view(), name="results-public-round"),
                # Public Ballots
                path(
                    "add/",
