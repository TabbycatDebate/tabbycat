...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    models.EmailField(
                        blank=True, max_length=254, null=True, verbose_name="e-mail address"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text='Name to be displayed, e.g., "Novice", "ESL"',
                        max_length=50,
                        verbose_name="name",
                    ),
                ),
                (
                    "slug",
                    models.SlugField(
                        help_text='Slug for URLs, e.g., "novice", "esl"', verbose_name="slug"
                    ),
                ),
                (
                    "seq",
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="At most this many speakers will be shown on the public tab for this category, or use 0 for no limit",
                        verbose_name="limit",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="If checked, this category will be included in the speaker category tabs shown to the public",
                        verbose_name="public",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("N", "none"), ("S", "swing"), ("C", "composite"), ("B", "bye")],
                        default="N",
                        max_length=1,
                        verbose_name="type",
                    ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, to="breakqual.BreakCategory", verbose_name="break categories"
                    ),
                ),
                (
                    "division",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="If checked, this adjudicator will never be auto-allocated a voting position, regardless of their score",
                        verbose_name="always trainee",
                    ),
                ),
        ...
        migrations.AlterUniqueTogether(
            name="team",
            unique_together=set(
                [("reference", "institution", "tournament"), ("emoji", "tournament")]
            ),
        ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, to="participants.SpeakerCategory", verbose_name="speaker categories"
            ),
        ),
        migrations.AddField(
            model_name="speaker",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                to="participants.Institution",
                verbose_name="institution conflicts",
            ),
        ),
        migrations.AddField(
            model_name="adjudicator",
