...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RenameIndex(
            model_name="team",
            new_name="participant_tournam_160efa_idx",
            old_fields=("tournament", "institution", "short_reference"),
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=utils.models.UniqueConstraint(
                fields=("tournament", "seq"), name="partici_speakercategory_tournament__seq_uniq"
            ),
        ),
        migrations.AddConstraint(
            model_name="speakercategory",
            constraint=utils.models.UniqueConstraint(
                fields=("tournament", "slug"), name="partici_speakercategory_tournament__slug_uniq"
            ),
        ),
        migrations.AddConstraint(
            model_name="team",
            constraint=utils.models.UniqueConstraint(
                fields=("reference", "institution", "tournament"),
                name="partici_team_reference__institution__tournament_uniq",
            ),
        ),
        migrations.AddConstraint(
            model_name="team",
            constraint=utils.models.UniqueConstraint(
                fields=("emoji", "tournament"), name="partici_team_emoji__tournament_uniq"
            ),
        ),
    ]
