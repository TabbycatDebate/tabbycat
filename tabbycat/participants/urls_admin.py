...
urlpatterns = [
    path("list/", views.AdminParticipantsListView.as_view(), name="participants-list"),
    path(
        "institutions/",
    ...
    path(
        "code-names/", views.AdminCodeNamesListView.as_view(), name="participants-code-names-list"
    ),
    path("email/", views.EmailTeamRegistrationView.as_view(), name="participants-email"),
    path(
        "eligibility/",
    ...
    path("team/<int:pk>/", views.TeamRecordView.as_view(), name="participants-team-record"),
    path(
        "adjudicator/<int:pk>/",
