...
EMOJI_LIST = (
    ...
    # ---------------------
    # NOSHOW    ("☺️", "White Smiling Face"),
    # NOSHOW    ("☹", "White Frowning Face"),
    ...
    # 2 SIMILAR ("😶", "Face Without Mouth"),
                ...
                ("😣", "Persevering Face"),
                ("😥", "Disappointed Face"),
    # 2 SIMILAR ("😪", "Sleepy Face"),
    # 2 SIMILAR ("😫", "Tired Face"),
    # 2 SIMILAR ("😌", "Relieved Face"),
                ("😜", "Stuck-Out Tongue"),
    # 2 SIMILAR ("😝", "Face With Stuck-Out Tongue and Tightly-Closed Eyes"),
    # 2 SIMILAR ("😒", "Unamused Face"),
                ("😓", "Cold Sweat"),
    # 2 SIMILAR ("😔", "Pensive Face"),
                ("😖", "Confounded Face"),
                ("😷", "Medical Mask"),
                ("😲", "Astonished Face"),
	# 2 SIMILAR ("😞", "Disappointed Face"),
    # 2 SIMILAR ("😤", "Face With Look of Triumph"),
    # 2 SIMILAR ("😢", "Crying Face"),
                ("😭", "Crying Face"),
    # 2 SIMILAR ("😨", "Fearful Face"),
    # 2 SIMILAR ("😩", "Weary Face"),
    # 2 SIMILAR ("😰", "Face With Open Mouth and Cold Sweat"),
                ("😱", "Screaming Face"),
                ("😳", "Flushed Face"),
                ("😵", "Dizzy Face"),
                ("😡", "Pouting Face"),
    # 2 SIMILAR ("😠", "Angry Face"),
                ("👿", "Imp Face"),
    ...
    # DULL      ("🙎", "Person With Pouting Face"),
                ("🙅", "Block Gesture"),
                ("🙆", "OK Gesture"),
                ("💁", "Information Gesture"),  # for reply standings
                ("🙋", "Raised Hand"),
                ("🙇", "Deep Bow"),
                ("🙌", "Celebration Hands"),
                ("🙏", "Pray Hands"),
    ...
    # Unicode    Version 6.1
    # ---------------------
    # 2 SIMILAR ("😀", "Grinning Face"),
    # 2 SIMILAR ("😗", "Kissing Face"),
                ("😙", "Smooch Face"),
                ("😑", "Expressionless Face"),
                ("😮", "Stunned Face"),
    # 2 SIMILAR ("😯", "Hushed Face"),
                ("😴", "Sleeping Face"),
                ("😛", "Tongue Face"),
    # 2 SIMILAR ("😕", "Confused Face"),
    # 2 SIMILAR ("😟", "Worried Face"),
    ...
    # Unicode    Version 7.0
    # ---------------------
    # 2 SIMILAR ("🙂", "Slightly Smiling Face"),
    # 2 SIMILAR ("🙁", "Slightly Frowning Face"),
                ("🕵", "Spy"),
