...
class Team(models.Model):
    ...
    def construct_emoji():
        emoji_options = initialise_emoji_options(Team.objects.all())
        return get_emoji(emoji_options)

    emoji = models.CharField(max_length=2, blank=True, null=True, default=construct_emoji, choices=EMOJI_LIST) # uses null=True to allow multiple teams to have no emoji
