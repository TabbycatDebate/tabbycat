...
class Team(models.Model):
    ...
    short_name = models.CharField(max_length=50, verbose_name="Short name (autogenerated)",
        help_text="The name shown in the draw, including institution name. This is autogenerated, so do not edit this yourself.")
    long_name = models.CharField(max_length=200, verbose_name="Long name (autogenerated)",
        help_text="The full name of the team, including institution name. This is autogenerated, so do not edit this yourself.")
