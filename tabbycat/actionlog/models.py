...
class ActionLogEntry(models.Model):
    ...
    ACTION_TYPE_CHOICES = (
        ...
        (ACTION_TYPE_VENUE_CONSTRAINTS_ADJ_EDIT       , _("Edited room-adjudicator constraints")),
        (ACTION_TYPE_VENUE_CONSTRAINTS_TEAM_EDIT      , _("Edited room-team constraints")),
        (ACTION_TYPE_VENUE_CONSTRAINTS_INST_EDIT      , _("Edited room-institution constraints")),
        (ACTION_TYPE_VENUE_CONSTRAINTS_DIV_EDIT       , _("Edited room-division constraints")),
