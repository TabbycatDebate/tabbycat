    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=utils.models.UniqueConstraint(
                fields=("debate_team", "preference", "ballot_submission"),
                name="motions_debateteammotionpreference_debate_team__preference__ballot_submission_uniq",
            ),
        ),
        migrations.AddConstraint(
            model_name="roundmotion",
            constraint=utils.models.UniqueConstraint(
                fields=("round", "seq"), name="motions_roundmotion_round__seq_uniq"
            ),
        ),
    ]
