...
var _App = require('./templates/vue/App.vue');
...
new _vue2.default({
  ...
  data: {
    tablesData: tablesData // Import from global setting
  }
});

},{"./templates/vue/App.vue":5,"vue":3}],5:[function(require,module,exports){
'use strict';
...
var _Table = require('./tables/Table.vue');
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\n<template v-for=\"tableData in tablesData\">\n  <smart-table :table-headers=\"tableData['head']\" :table-content=\"tableData['data']\" :table-class=\"tableData['class']\" :filter-key=\"\" :default-sort-key=\"tableData['sort_key']\" :default-sort-order=\"tableData['sort_order']\">\n  </smart-table>\n</template>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6aaeefaf", module.exports)
  } else {
    hotAPI.update("_v-6aaeefaf", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./tables/Table.vue":8,"vue":3,"vue-hot-reload-api":2}],6:[function(require,module,exports){
'use strict';
...
exports.default = {
  ...
  computed: {
    sortClasses: function sortClasses() {
  ...
  methods: {
    ...
    notifySortByHeader: function notifySortByHeader() {
...
exports.default = {
  ...
  methods: {
    ...
    getDefaultSortIndex: function getDefaultSortIndex() {
      // Find the index of the column that matches the default sorting key
      var index = null;
      if (typeof this.tableHeaders !== 'undefined') {
  ...
  events: {
    receiveSortByHeader: function receiveSortByHeader(headerIndex) {
  ...
  computed: {
    ...
    headers: function headers() {
      ...
      var headers = [];
      if (typeof this.tableContent[0] !== 'undefined') {
        // Check table is not empty
        for (var i = 0; i < this.tableHeaders.length; i++) {
