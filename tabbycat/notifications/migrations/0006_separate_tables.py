    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                null=True, max_length=254, unique=True, verbose_name="Message-ID"
            ),
            preserve_default=False,
        ),
        migrations.AddField(
            ...
            name="hook_id",
            field=models.CharField(
                blank=True, max_length=16, unique=True, null=True, verbose_name="Hook-ID"
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="notifications.SentMessageRecord",
