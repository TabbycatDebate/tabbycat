...
class SentMessage(models.Model):
    ...
    message_id = models.CharField(
        max_length=254, unique=True, null=True, verbose_name="Message-ID"
    )  # Technical, Untranslatable term
    hook_id = models.CharField(
        max_length=16, unique=True, blank=True, null=True, verbose_name="Hook-ID"
    )

    recipient = models.ForeignKey(
        "participants.Person", models.SET_NULL, null=True, verbose_name=_("recipient")
    )
    method = models.CharField(max_length=1, choices=METHOD_TYPE_CHOICES, verbose_name=_("method"))

    email = models.EmailField(null=True, verbose_name=_("email"))
    context = models.JSONField(blank=True, null=True, verbose_name=_("context"))

    notification = models.ForeignKey(
        "notifications.BulkNotification", models.CASCADE, verbose_name=_("notification")
    )
...
class BulkNotification(models.Model):
    ...
    event = models.CharField(max_length=20, choices=EventType.choices, verbose_name=_("event"))
    timestamp = models.DateTimeField(auto_now_add=True, verbose_name=_("timestamp"))
    ...
    subject_template = models.TextField(null=True, verbose_name=_("subject template"))
    body_template = models.TextField(null=True, verbose_name=_("body template"))
...
class EmailStatus(models.Model):
    ...
    email = models.ForeignKey(
        "notifications.SentMessage", models.CASCADE, verbose_name=_("email message")
    )
    timestamp = models.DateTimeField(auto_now_add=True, verbose_name=_("timestamp"))
    event = models.CharField(max_length=20, choices=EventType.choices, verbose_name=_("event"))
    data = models.JSONField(blank=True, null=True, verbose_name=_("context"))
