<template>
  ...
  <div class="draw-header subtitle">
    ...
    <div class="thead flex-cell flex-1" data-toggle="tooltip" title="The assigned importance value of this debate">
      <span class="glyphicon glyphicon-stats"></span>
    </div>
    ...
    <div class="thead flex-cell flex-3 debate-team" data-toggle="tooltip" title="test"
      v-for="position in positions">
    {{ position }}
    </div>

    <div class="thead flex-cell flex-6" data-toggle="tooltip" title="test">
      Panel
    </div>
