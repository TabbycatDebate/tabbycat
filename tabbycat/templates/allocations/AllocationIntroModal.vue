        ...
        <div class="modal-body">
          <div class="tab-content lead p-3" id="pills-tabContent">
            ...
            <div class="tab-pane fade" id="pills-sharding" role="tabpanel">
              ...
              <p><strong class="text-danger">Important Note:</strong> this feature is in beta, and its use requires clear communication amongst those using it. You need everyone to be absolutely clear how the draw is being divided (i.e. <em>thirds</em> by <em>bracket</em> using <em>top-to-bottom</em>) and be sure that only one person is ever viewing each subset. If multiple people are viewing the same subset, or one person is still changing the entire draw you may end up overwriting each other's changes without realising it.</p>
