...
class Venue(models.Model):
    ...
    url = models.URLField(
        ...
        blank=True,
        help_text=_(
            "A URL that contains extra information about this room, e.g. a map or a meeting link (for online tournaments)"
        ),
    )
...
class VenueCategory(models.Model):
    ...
    DISPLAY_PREFIX = "P"
    DISPLAY_SUFFIX = "S"
    DISPLAY_IN_VENUE_NAME_CHOICES = (
        (DISPLAY_NONE, _("Don't display in room name")),
    ...
    name = models.CharField(
        ...
        verbose_name=_("name"),
        help_text=_(
            'Name of category, e.g., "Purple", "Step-free access", '
    ...
    tournament = models.ForeignKey(
        "tournaments.Tournament", models.CASCADE, null=True, verbose_name=_("tournament")
    )

    display_in_venue_name = models.CharField(
        max_length=1,
        choices=DISPLAY_IN_VENUE_NAME_CHOICES,
    ...
    display_in_public_tooltip = models.BooleanField(
        ...
        help_text=_(
            "Displays the description in the tooltip for the room on public pages. "
...
class VenueConstraint(models.Model):
    ...
    category = models.ForeignKey(VenueCategory, models.CASCADE, verbose_name=_("category"))
    priority = models.IntegerField(verbose_name=_("priority"))

    subject_content_type = LabelByNameForeignKey(
        ContentType,
        models.CASCADE,
