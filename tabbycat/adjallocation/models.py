...
class DebateAdjudicator(models.Model):
    ...
    debate = models.ForeignKey("draw.Debate", models.CASCADE, verbose_name=_("debate"))
...
class AdjudicatorInstitutionConflict(models.Model):
    ...
    institution = models.ForeignKey(
        "participants.Institution", models.CASCADE, verbose_name=_("institution")
    )
...
class PreformedPanelAdjudicator(models.Model):
    panel = models.ForeignKey(PreformedPanel, models.CASCADE, verbose_name=_("panel"))
    adjudicator = models.ForeignKey(
        "participants.Adjudicator", models.CASCADE, verbose_name=_("adjudicator")
    )
    type = models.CharField(
        max_length=2, choices=DebateAdjudicator.TYPE_CHOICES, verbose_name=_("type")
    )
