...
urlpatterns = [
    path('round/<int:round_seq>/', include([
        ...
        path('team/categories/',
            views.TeamCategoryRankStandingsView.as_view(),
            name='standings-team-categories'),
        ...
        path('speaker/categories/',
            views.SpeakerCategoryRankStandingsView.as_view(),
            name='standings-speaker-categories'),
