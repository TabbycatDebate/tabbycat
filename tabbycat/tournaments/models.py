...
class Round(models.Model):
    ...
    def debate_set_with_prefetches(self, filter_kwargs=None, ordering=('venue__name',),
            ...
            wins=False, ballotsets=False, results=False, venues=True, institutions=False):
        ...
        if ballotsubs or ballotsets or results:
        ...
        if ballotsubs or ballotsets or results:
            populate_confirmed_ballots(debates, motions=True, ballotsets=ballotsets, results=results)
        if wins:
