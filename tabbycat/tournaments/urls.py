...
urlpatterns = [
    path("", views.TournamentPublicHomeView.as_view(), name="tournament-public-index"),
    path("admin/", views.TournamentAdminHomeView.as_view(), name="tournament-admin-home"),
    path(
        "assistant/", views.TournamentAssistantHomeView.as_view(), name="tournament-assistant-home"
    ),
    ...
    # Round progression
    path(
        "admin/round/<int:round_seq>/complete/check/",
        views.CompleteRoundCheckView.as_view(),
        name="tournament-complete-round-check",
    ),
    path(
        "admin/round/<int:round_seq>/complete/toggle-silent/",
        views.CompleteRoundToggleSilentView.as_view(),
        name="tournament-complete-round-toggle-silent",
    ),
    path(
        "admin/round/<int:round_seq>/complete/",
        views.CompleteRoundView.as_view(),
        name="tournament-complete-round",
    ),
    path(
        "admin/set-current-round/",
        views.SetCurrentRoundView.as_view(),
        name="tournament-set-current-round",
    ),
    # Other pages
    path(
        "admin/set-round-weights/", views.SetRoundWeightingsView.as_view(), name="set-round-weights"
    ),
    path("admin/configure/", views.ConfigureTournamentView.as_view(), name="tournament-configure"),
    path(
        "admin/fix-debate-teams/",
