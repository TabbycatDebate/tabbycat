...
class TestRoundLookup(TestCase):
    ...
    def setUp(self):
        ...
        self.rd = Round.objects.create(
            tournament=self.tournament, name="A Test Round", abbreviation="ATR", seq=1
        )
    ...
    def test_lookup_with_tournament(self):
        ...
        self.assertRaises(
            ObjectDoesNotExist, Round.objects.lookup, "A Test Round", tournament=other_tournament
        )
        self.assertRaises(
            ObjectDoesNotExist, Round.objects.lookup, "ATR", tournament=other_tournament
        )
