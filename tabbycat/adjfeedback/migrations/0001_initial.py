        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "from_adj",
                    models.BooleanField(
                        help_text="Adjudicators should be asked this question (about other adjudicators)",
                        verbose_name="from adjudicator",
                    ),
                ),
                (
                    "from_team",
                    models.BooleanField(
                        help_text="Teams should be asked this question", verbose_name="from team"
                    ),
                ),
                (
                    "answer_type",
