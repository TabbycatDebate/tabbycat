...
urlpatterns = [
    # Overviews
    path("progress/", views.PublicFeedbackProgress.as_view(), name="public_feedback_progress"),
    # Submission via Public Form
    path("add/", views.PublicAddFeedbackIndexView.as_view(), name="adjfeedback-public-add-index"),
    path(
