...
from utils.tests import (
    ...
    AssistantTournamentViewSimpleLoadTestMixin,
    ConditionalTournamentViewSimpleLoadTestMixin,
)
...
class AssistantCheckInAdjudicatorsPrintablesView(
    AssistantTournamentViewSimpleLoadTestMixin, TestCase
):
    view_name = "assistant-checkin-print"
    view_reverse_kwargs = {"kind": "adjudicators"}
