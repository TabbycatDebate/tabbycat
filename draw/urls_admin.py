...
urlpatterns = [
    ...
    url(r'^side_allocations/$',                             views.side_allocations,     name='side_allocations'),

    url(r'^round/(?P<round_seq>\d+)/matchups/edit/$',       views.draw_matchups_edit,   name='draw_matchups_edit'),
    url(r'^round/(?P<round_seq>\d+)/matchups/save/$',       views.save_matchups,        name='save_matchups'),

    url(r'^round/(?P<round_seq>\d+)/start_time/set/$',      views.set_round_start_time, name='set_round_start_time'),
