...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.use_institution_prefix'
        db.add_column(u'debate_team', 'use_institution_prefix',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.use_institution_prefix'
        db.delete_column(u'debate_team', 'use_institution_prefix')
