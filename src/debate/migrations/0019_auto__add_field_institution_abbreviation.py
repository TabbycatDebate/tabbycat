...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Institution.abbreviation'
        db.add_column(u'debate_institution', 'abbreviation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Institution.abbreviation'
        db.delete_column(u'debate_institution', 'abbreviation')
