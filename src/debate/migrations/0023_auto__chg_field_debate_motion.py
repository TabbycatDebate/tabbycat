...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Debate.motion'
        db.alter_column(u'debate_debate', 'motion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debate.Motion'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Debate.motion'
        db.alter_column(u'debate_debate', 'motion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debate.Motion'], null=True))
