...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.checkin_message'
        db.alter_column('debate_person', 'checkin_message', self.gf('django.db.models.fields.TextField')(blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Person.checkin_message'
        db.alter_column('debate_person', 'checkin_message', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))
