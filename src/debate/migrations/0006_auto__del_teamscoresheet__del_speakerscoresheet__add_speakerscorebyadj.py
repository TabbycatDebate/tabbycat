...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('debate_speakerscorebyadj', (
        ...
        db.send_create_signal('debate', ['SpeakerScoreByAdj'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('debate_speakerscorebyadj')
    ...
    models = {
        ...
        'debate.speakerscorebyadj': {
            'Meta': {'unique_together': "[('debate_adjudicator', 'speaker')]", 'object_name': 'SpeakerScoreByAdj'},
