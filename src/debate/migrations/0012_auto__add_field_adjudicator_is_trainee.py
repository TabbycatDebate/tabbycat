...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Adjudicator.is_trainee'
        db.add_column('debate_adjudicator', 'is_trainee', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Adjudicator.is_trainee'
        db.delete_column('debate_adjudicator', 'is_trainee')
