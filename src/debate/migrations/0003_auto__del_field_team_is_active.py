...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('debate_team', 'is_active')
    
    
    def backwards(self, orm):
        
        # Adding field 'Team.is_active'
        db.add_column('debate_team', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
