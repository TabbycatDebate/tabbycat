...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.checkin_message'
        db.add_column('debate_person', 'checkin_message', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Person.checkin_message'
        db.delete_column('debate_person', 'checkin_message')
    ...
    models = {
        ...
        'debate.person': {
            ...
            'checkin_message': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
