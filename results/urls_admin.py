...
urlpatterns = [
    ...
    url(r'^round/(?P<round_seq>\d+)/ballot_checkin/$',
        views.ballot_checkin,
        name='ballot_checkin'),
    url(r'^round/(?P<round_seq>\d+)/ballot_checkin/get_details/$',
        views.ballot_checkin_get_details,
        name='ballot_checkin_get_details'),
    url(r'^round/(?P<round_seq>\d+)/ballot_checkin/post/$',
    ...
    url(r'^ballots/(?P<ballotsub_id>\d+)/edit/$',
        ...
        name='edit_ballotset'),
    url(r'^debate/(?P<debate_id>\d+)/new_ballotset/$',
        views.new_ballotset,
        name='new_ballotset'),
]
