...
def team_standings(request, round):
    ...
    return r2r(request, 'standings/teams.html', dict(teams=teams, rounds=rounds,
...
def division_standings(request, round):
    ...
    return r2r(request, 'standings/divisions.html', dict(teams=teams))
...
def speaker_standings(request, round):
    ...
    return r2r(request, 'standings/speakers.html', dict(speakers=speakers,
                                        rounds=rounds))
...
def novice_standings(request, round):
    ...
    return r2r(request, "standings/novices.html", dict(speakers=speakers,
                                        rounds=rounds))
...
def reply_standings(request, round):
    ...
    return r2r(request, 'standings/replies.html', dict(speakers=speakers,
                                        rounds=rounds))
...
def motion_standings(request, round):
    ...
    return r2r(request, 'standings/motions.html', dict(motions=motions))
...
def public_speaker_tab(request, t):
    ...
    speakers = get_speaker_standings(rounds, round)
    return r2r(request, 'standings/public_speaker_tab.html', dict(speakers=speakers,
...
def public_novices_tab(request, t):
    ...
    rounds = round.tournament.prelim_rounds(until=round).order_by('seq')
    speakers = get_speaker_standings(rounds, round, only_novices=True)
    return r2r(request, 'standings/public_novices_tab.html', dict(speakers=speakers,
            rounds=rounds, round=round))
...
def public_replies_tab(request, t):
    ...
    rounds = t.prelim_rounds(until=round).order_by('seq')
    speakers = get_speaker_standings(rounds, round, for_replies=True)
    return r2r(request, 'standings/public_reply_tab.html', dict(speakers=speakers,
            rounds=rounds, round=round))
...
def public_team_tab(request, t):
    ...
    return r2r(request, 'standings/public_team_tab.html', dict(teams=teams,
...
def public_motions_tab(request, t):
    ...
    motions = list()
    motions = Motion.objects.statistics(round=round)
    return r2r(request, 'standings/public_motions_tab.html', dict(motions=motions))
