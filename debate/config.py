...
SETTINGS = OrderedDict([
    ...
    ('adj_feedback_score_min',      (float, 'Minimum allowed adjudicator feedback score',                  1)),
    ('adj_feedback_score_max',      (float, 'Maximum allowed adjudicator feedback score',                  5)),
    ('adj_feedback_score_step',     (float, 'Adjudicator feedback score steps allowed',                    1)),
