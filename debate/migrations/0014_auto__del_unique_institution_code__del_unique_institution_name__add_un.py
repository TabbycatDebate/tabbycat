...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Institution', fields ['code', 'tournament']
        db.create_unique('debate_institution', ['code', 'tournament_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Institution', fields ['code', 'tournament']
        db.delete_unique('debate_institution', ['code', 'tournament_id'])
