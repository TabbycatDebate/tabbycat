...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Person'
        db.create_table('debate_person', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('barcode_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ))
        db.send_create_signal('debate', ['Person'])

        # Deleting field 'Adjudicator.id'
        db.delete_column('debate_adjudicator', 'id')

        # Deleting field 'Adjudicator.name'
        db.delete_column('debate_adjudicator', 'name')

        # Adding field 'Adjudicator.person_ptr'
        db.add_column('debate_adjudicator', 'person_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['debate.Person'], unique=True, primary_key=True), keep_default=False)

        # Deleting field 'Speaker.id'
        db.delete_column('debate_speaker', 'id')

        # Deleting field 'Speaker.name'
        db.delete_column('debate_speaker', 'name')

        # Adding field 'Speaker.person_ptr'
        db.add_column('debate_speaker', 'person_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['debate.Person'], unique=True, primary_key=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'Person'
        db.delete_table('debate_person')

        # Adding field 'Adjudicator.id'
        db.add_column('debate_adjudicator', 'id', self.gf('django.db.models.fields.AutoField')(default=None, primary_key=True), keep_default=False)

        # Adding field 'Adjudicator.name'
        db.add_column('debate_adjudicator', 'name', self.gf('django.db.models.fields.CharField')(default=None, max_length=40), keep_default=False)

        # Deleting field 'Adjudicator.person_ptr'
        db.delete_column('debate_adjudicator', 'person_ptr_id')

        # Adding field 'Speaker.id'
        db.add_column('debate_speaker', 'id', self.gf('django.db.models.fields.AutoField')(default=None, primary_key=True), keep_default=False)

        # Adding field 'Speaker.name'
        db.add_column('debate_speaker', 'name', self.gf('django.db.models.fields.CharField')(default=None, max_length=40), keep_default=False)

        # Deleting field 'Speaker.person_ptr'
        db.delete_column('debate_speaker', 'person_ptr_id')
    ...
    models = {
        ...
        'debate.adjudicator': {
            ...
            'cv_score': ('django.db.models.fields.FloatField', [], {'default': '0'}),
