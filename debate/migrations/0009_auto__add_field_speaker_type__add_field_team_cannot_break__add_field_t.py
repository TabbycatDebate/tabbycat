...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Speaker.type'
        db.add_column('debate_speaker', 'type', self.gf('django.db.models.fields.CharField')(default='N', max_length=1), keep_default=False)

        # Adding field 'Team.cannot_break'
        db.add_column('debate_team', 'cannot_break', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Team.type'
        db.add_column('debate_team', 'type', self.gf('django.db.models.fields.CharField')(default='N', max_length=1), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Speaker.type'
        db.delete_column('debate_speaker', 'type')

        # Deleting field 'Team.cannot_break'
        db.delete_column('debate_team', 'cannot_break')

        # Deleting field 'Team.type'
        db.delete_column('debate_team', 'type')
