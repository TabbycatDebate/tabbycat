...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename field 'name' to 'reference'
        db.rename_column(u'debate_team', 'name', 'reference')

    def backwards(self, orm):
        # Rename field 'reference' to 'name'
        db.rename_column(u'debate_team', 'reference', 'name')
