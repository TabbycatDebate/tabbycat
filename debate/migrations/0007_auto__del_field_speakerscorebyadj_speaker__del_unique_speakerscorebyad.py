...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SpeakerScoreByAdj.speaker'
        db.delete_column('debate_speakerscorebyadj', 'speaker_id')

        # Removing unique constraint on 'SpeakerScoreByAdj', fields ['debate_adjudicator', 'speaker']
        #db.delete_unique('debate_speakerscorebyadj', ['debate_adjudicator_id', 'speaker_id'])

        # Adding unique constraint on 'SpeakerScoreByAdj', fields ['debate_adjudicator', 'position', 'debate_team']
        db.create_unique('debate_speakerscorebyadj', ['debate_adjudicator_id', 'position', 'debate_team_id'])
    
    
    def backwards(self, orm):
        
        # Adding field 'SpeakerScoreByAdj.speaker'
        db.add_column('debate_speakerscorebyadj', 'speaker', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['debate.Speaker']), keep_default=False)

        # Adding unique constraint on 'SpeakerScoreByAdj', fields ['debate_adjudicator', 'speaker']
        db.create_unique('debate_speakerscorebyadj', ['debate_adjudicator_id', 'speaker_id'])

        # Removing unique constraint on 'SpeakerScoreByAdj', fields ['debate_adjudicator', 'position', 'debate_team']
        db.delete_unique('debate_speakerscorebyadj', ['debate_adjudicator_id', 'position', 'debate_team_id'])
