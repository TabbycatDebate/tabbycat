...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Debate.room_rank'
        db.add_column('debate_debate', 'room_rank', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Debate.room_rank'
        db.delete_column('debate_debate', 'room_rank')
