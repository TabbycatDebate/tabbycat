...
urlpatterns = patterns('debate.views',
    ...
    url(r'^add_ballot/adjudicator/h/(?P<url_key>\w+)/$', 'public_new_ballots_key', name='public_new_ballots_key'),
    ...
    url(r'^admin/feedback_urls/$', 'randomised_urls', name='randomised_urls'),
    url(r'^admin/feedback_urls/generate/$', 'generate_randomised_urls', name='generate_randomised_urls'),
