...
urlpatterns = patterns('debate.views',
    ...
    url(r'^add_feedback/team/h/(?P<url_hash>\w+)/$', 'public_enter_feedback_hash', name='public_enter_feedback_team_hash'),
    url(r'^add_feedback/adjudicator/h/(?P<url_hash>\w+)/$', 'public_enter_feedback_hash', name='public_enter_feedback_adjudicator_hash'),
