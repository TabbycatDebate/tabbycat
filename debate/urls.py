...
urlpatterns = patterns('debate.views',
    ...
    url(r'^public/add_feedback/team/(?P<team_id>\d+)/$', 'public_enter_feedback_team',
        name='public_enter_feedback_team'),
    url(r'^public/add_feedback/team/(?P<team_id>\d+)/get/$', 'public_enter_feedback_team_content',
        name='public_enter_feedback_team_content'),
    url(r'^public/add_feedback/adjudicator/(?P<adj_id>\d+)/$', 'public_enter_feedback_adjudicator',
    ...
    url(r'^adjudicators/feedback/(?P<adj_id>\d+)/$',
