...
urlpatterns = patterns('debate.views',
    ...
    url(r'^add_ballot/adjudicator/(?P<adj_id>\d+)/$', 'public_new_ballots_by_id', name='public_new_ballots'),
    url(r'^add_ballot/adjudicator/h/(?P<url_hash>\w+)/$', 'public_new_ballots_by_hash', name='public_new_ballots_hash'),
    url(r'^add_feedback/team/(?P<team_id>\d+)/$', 'public_enter_feedback_team_by_id', name='public_enter_feedback_team'),
    url(r'^add_feedback/adjudicator/(?P<adj_id>\d+)/$', 'public_enter_feedback_adjudicator_by_id', name='public_enter_feedback_adjudicator'),
    url(r'^add_feedback/team/h/(?P<url_hash>\w+)/$', 'public_enter_feedback_team_by_hash', name='public_enter_feedback_team_hash'),
    url(r'^add_feedback/adjudicator/h/(?P<url_hash>\w+)/$', 'public_enter_feedback_adjudicator_by_hash', name='public_enter_feedback_adjudicator_hash'),
    ...
    url(r'^admin/adjudicators/feedback_latest/$', 'adj_latest_feedback', name='adj_latest_feedback'),
    url(r'^admin/adjudicators/feedback_source/list/$', 'adj_source_feedback', name='adj_source_feedback'),
    url(r'^admin/adjudicators/feedback_source/team/(?P<team_id>\d+)/$', 'team_feedback_list', name='team_feedback_list'),
    url(r'^admin/adjudicators/feedback_source/adjudicator(?P<adj_id>\d+)/$', 'adj_feedback_list', name='adj_feedback_list'),
    ...
    url(r'^admin/hash_urls/generate/$', 'generate_hash_urls', name='generate_hash_urls'),
