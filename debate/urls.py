...
urlpatterns = patterns('debate.views',
    ...
    url(r'^public/add_feedback/team/(?P<team_id>\d+)/$', 'public_enter_feedback_team', name='public_enter_feedback_team'),
    url(r'^public/add_feedback/adjudicator/(?P<adj_id>\d+)/$', 'public_enter_feedback_adjudicator', name='public_enter_feedback_adjudicator'),
