...
urlpatterns = patterns('debate.views',
    ...
    url(r'^add_ballot/adjudicator/(?P<adj_id>\d+)/$', 'public_new_ballots_id', name='public_new_ballots'),
    url(r'^add_ballot/adjudicator/h/(?P<url_hash>\w+)/$', 'public_new_ballots_hash', name='public_new_ballots_hash'),
    ...
    url(r'^add_feedback/team/h/(?P<url_hash>\w+)/$', 'public_enter_feedback_hash', {'source_type': m.Team}, name='public_enter_feedback_team_hash'),
    url(r'^add_feedback/adjudicator/h/(?P<url_hash>\w+)/$', 'public_enter_feedback_hash', {'source_type': m.Adjudicator}, name='public_enter_feedback_adjudicator_hash'),
