...
urlpatterns = [
    ...
    url(r'teams/update/$',          views.update_availability,
        { 'active_attr': 'team', 'active_model': models.ActiveTeam, 'update_method': 'set_available_teams' },
    ...
    url(r'venues/update/$',         views.update_availability,
        { 'active_attr': 'venue', 'active_model': models.ActiveVenue, 'update_method': 'set_available_venues' },
    ...
    url(r'adjudicators/update/$',   views.update_availability,
        { 'active_attr': 'adjudicator', 'active_model': models.ActiveAdjudicator, 'update_method': 'set_available_adjudicators' },
