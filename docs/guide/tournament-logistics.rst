...
While this guide aims for general relevance, it is relatively opinionated and mostly written from the perspective of people whose primary experience is tabbing at Australasian tournaments using Tabbycat. We welcome feedback and additions that can account for differences common in different formats, circuits, and software. In the future, if the guide becomes more general and more extensive, it could be spun off into a separate project.
